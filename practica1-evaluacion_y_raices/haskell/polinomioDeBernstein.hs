...
Utilizado en el método constructivo de la aproximación de Weierstrass,
que dice que toda función continua en un intervalo cerrado se puede aproximar
todo lo que se desee a un polinomio ( dicho polinomio es el de Bernstein). 
...
bernstein :: (Enum a, Floating a) => a -> (a -> a) -> a -> a -> a -> a
